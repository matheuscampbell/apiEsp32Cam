function UinovoProduto(product) {
    var html = `<div class="col col-lg-3 col-md-4 col-sm-6 col-6" style="padding: 0 2px;padding-bottom: 4px;">
                    <div class="card btn p-0 text-start" style="box-shadow: 0px 0px 20px 0px rgba(33,37,41,0.11);border-radius: 10px;">
                        <div class="card-body">
                            ...
                            <div id="imagem-doproduto-1" class="productImage" style="margin: -16px;background-position: top;background-size: cover;background-repeat: space;border-radius: 10px;background: url(' `+product.image+` ')"></div>
    ...
    $('#products'+product.department).append(html);
}

function UinovoDepartamento(department) {
    var html = `
    <section id="products-section-1" style="margin-top: 5px;">
            ...
            <div class="row" id="products{department.id}">
...
function uiModalUploadImage(){
    var id = modal('Cadastre sua foto',
       ...
       <div class="form-group">
            ...
            <input class="form-control" type="file" id="upfoto">
       </div>
